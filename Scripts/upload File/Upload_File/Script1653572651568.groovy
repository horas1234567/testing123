...
WebUI.uploadFile(findTestObject('Page_filehosting.org  free easy unlimited f_4efffe/input_Select a file_upload_file'), 'D:\\Laporan mama\\April.pdf')

WebUI.setText(findTestObject('Page_filehosting.org  free easy unlimited f_4efffe/input_Your email address_uploader_email'), 
    'manullanghoras06@gmail.com')
